...
python -W ignore -m torch.distributed.launch --nnodes 1 --node_rank 0 --nproc_per_node=4 \
       run.py \
       --model_dirpath ../pretrained_checkpoints/llm/logs/lucagplm/v2.0/token_level,span_level,seq_level,structure_level/lucaone_gplm/20231125113045/log.txt \
       --log_filepath ../pretrained_checkpoints/llm/models/lucagplm/v2.0/token_level,span_level,seq_level,structure_level/lucaone_gplm/20231125113045/checkpoint-step5600000 \
